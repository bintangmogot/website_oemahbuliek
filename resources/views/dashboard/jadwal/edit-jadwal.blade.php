                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" 
                                ...
                                id="tanggal" 
                                class="form-control" 
                                value="{{ old('tanggal', $jadwalShift->tanggal->format('Y-m-d')) }}"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                <option value="1" {{ old('status', $jadwalShift->status) == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0" {{ old('status', $jadwalShift->status) == '0' ? 'selected' : '' }}>Dibatalkan</option>
                                <option value="2" {{ old('status', $jadwalShift->status) == '2' ? 'selected' : '' }}>Selesai</option>
                            </select>
                        </div>
                    </div>
