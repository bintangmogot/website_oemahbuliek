            ...
            <div class="profile-section">
                <div class="profile-avatar">
                    @if($user->foto_profil && Storage::disk('public')->exists($user->foto_profil))
                        <img src="{{ Storage::url($user->foto_profil) }}" size="50" alt="Profile" class="avatar-img" />
                    @else
            ...
            <div class="sidebar-menu">
                ...
                @if(session('role') === 'admin')
                    ...
                    <a href="{{ route('notifications.index') }}"
                        class="menu-item {{ request()->is('dashboard/messages*') ? 'active' : '' }}">
                    ...
                    <div class="divider"></div>
                    <a href="{{ route('laporan.kerugian') }}"
                        class="menu-item {{ request()->is('dashboard/laporan/kerugian-bahan-baku*') ? 'active' : '' }}">
                        <i class="fas fa-chart-line"></i><span>Kerugian Bahan Rusak</span>
                    </a>
                    <a href="{{ route('laporan.penggunaan') }}"
                        class="menu-item {{ request()->is('dashboard/laporan/penggunaan-bahan*') ? 'active' : '' }}">
                        <i class="fas fa-rocket"></i><span>Bahan Paling Dibutuhkan</span>
                    </a>
                    <a href="{{ route('laporan.stok-mati') }}"
                        class="menu-item {{ request()->is('dashboard/laporan/stok-mati*') ? 'active' : '' }}">
                        <i class="fas fa-bed"></i><span>Stok Belum Terpakai</span>
                    </a>
                    <a href="{{ route('laporan.penerimaan') }}"
                        class="menu-item {{ request()->is('dashboard/laporan/penerimaan-bahan*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('gaji-lembur.laporan') }}"
                        class="menu-item {{ request()->is('dashboard/gaji-lembur/laporan*') ? 'active' : '' }}">
                        <i class="fas fa-truck-loading"></i><span>Gaji Lembur/Pegawai</span>
                    </a>
                    <a href="{{ route('admin.gaji-pokok.generated') }}"
                        class="menu-item {{ request()->is('dashboard/gaji-pokok/generated*') ? 'active' : '' }}">
                        <i class="fas fa-truck-loading"></i><span>Gaji Pokok/Pegawai</span>
                    </a>
                    <a href="{{ route('admin.gaji-pokok.summary') }}"
                        class="menu-item {{ request()->is('dashboard/gaji-pokok/summary*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('shift.index') }}"
                        class="menu-item {{ request()->is('dashboard/shift*') ? 'active' : '' }}">
                        <i class="fas fa-clock"></i><span>Shift</span>
                    </a>
                    <a href="{{ route('pengaturan_gaji.index') }}"
                        class="menu-item {{ request()->is('dashboard/pengaturan-gaji*') ? 'active' : '' }}">
                ...
                @else
                    ...
                    <a href="{{ route('gaji-lembur.pegawai.index') }}"
                        class="menu-item {{ request()->is('dashboard/gaji-lembur*') ? 'active' : '' }}">
                        <i class="bi bi-person-workspace"></i><span>Laporan Lembur</span>
                    </a>
                    <a href="{{ route('pegawai.gaji-pokok.index') }}"
                        class="menu-item {{ request()->is('dashboard/gaji-pokok*') ? 'active' : '' }}">
    ...
    <nav class="main-navbar">
        <div class="navbar-content">
            ...
            <div class="navbar-actions">
                ...
                <a href="{{ route('notifications.index') }}"
                    class="menu-item icon-only position-relative p-1 px-2 {{ request()->is('dashboard/messages*') ? 'active' : '' }}">
                    <i class="bi bi-bell fs-5"></i>

                    @if(isset($unreadNotificationsCount) && $unreadNotificationsCount > 0)
                        <span
                            class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger text-white p-1"
